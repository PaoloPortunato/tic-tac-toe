...
public class TicTacToeView extends JFrame
{
    ...
    // FSU title bar.
    private final String   TITLE_TEXT          = "Tris Tic-Tac-Toe";
    ...
    // Game status label
    private final String   STATUS_TEXT         = "X muove per iniziare";
    ...
    private final String   NEW_GAME_BTN_TEXT   = "Inizia nuova partita";
    ...
    private final String   GAME_MODE_BTN_TEXT  = "Cambia Modalita";
